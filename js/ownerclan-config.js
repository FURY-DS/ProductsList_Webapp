...
const OWNERCLAN_CONFIG = {
  ...
  FIELDS: {
    ...
    sellingPrice:  { label: '판매가',              type: 'text',   placeholder: '자동 계산', readonly: true, highlight: true },
    supplyPrice:   { label: '공급가입력',          type: 'number', placeholder: '예: 40000' },
