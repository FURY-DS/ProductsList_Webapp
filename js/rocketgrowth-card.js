/* =====================================================
   ...
   명명 패턴: ForRocketgrowth 접미사 (lookupProductlistByCodeForRocketgrowth 등)

   ★ 로켓그로스 수식 (다른 판매 페이지와 다름):
   - 최종이익 = 판매가 - 최종원가 - 판매수수료 - 피킹라벨출고비 - 쿠팡입출고비용
   - (★ marketFee를 빼기(-)함! 다른 페이지는 마켓택배비를 더하기(+))
   - warehouseFee → 피킹라벨출고비 (키는 같지만 의미 다름)
   - marketFee → 쿠팡입출고비용 (키는 같지만 의미 다름, 부호도 반대)
   - 2개이상구매/복수품 전용 필드 없음
   ===================================================== */
