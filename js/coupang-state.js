/* =====================================================
   coupang-state.js - 쿠팡 상태 및 카드 데이터 모델
   ===================================================== */
...
/** ID로 쿠팡 카드 찾기 */
function findCoupangCard(id) {
  return coupangState.cards.find(c => c.id === id);
}

/** ID로 쿠팡 카드 인덱스 찾기 */
function findCoupangCardIndex(id) {
  return coupangState.cards.findIndex(c => c.id === id);
}
