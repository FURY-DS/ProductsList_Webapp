/* =====================================================
   rocketgrowth-config.js - 로켓그로스 전용 설정
   ===================================================== */

const ROCKETGROWTH_CONFIG = {
  // 페이지 식별자 (내보내기/가져오기 검증용)
  PAGE_ID: 'rocketgrowth',

  // localStorage 키
  STORAGE_KEY: 'rocketgrowth_v1',
  ...
  FIELDS: {
    ...
    warehouseFee:  { label: '피킹라벨출고비',          type: 'number', placeholder: '예: 3000' },
    marketFee:     { label: '쿠팡입출고비용',          type: 'number', placeholder: '예: 3000' },
